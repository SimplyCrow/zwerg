...
static const struct string_mapping ATTRIBUTE_ENCODINGS[] = {
        ...
        {DW_AT_abtract_origin, "DW_AT_abtract_origin"},
...
static const struct string_mapping ATTRIBUTE_FORM_CLASS[] = {
        {DW_FORM_CLASS_UNKNOWN, "DW_FORM_CLASS_UNKNOWN"},
        {DW_FORM_CLASS_INDIRECT, "CLASS_INDIRECT"},
        {DW_FORM_CLASS_SEC_OFFSET, "CLASS_SEC_OFFSET"},
        {DW_FORM_CLASS_ADDRESS, "CLASS_ADDRESS"},
        {DW_FORM_CLASS_ADDRPTR, "CLASS_ADDRPTR"},
        {DW_FORM_CLASS_BLOCK, "CLASS_BLOCK"},
        {DW_FORM_CLASS_CONSTANT, "CLASS_CONSTANT"},
        {DW_FORM_CLASS_EXPRLOC, "CLASS_EXPRLOC"},
        {DW_FORM_CLASS_FLAG, "CLASS_FLAG"},
        {DW_FORM_CLASS_LINEPTR, "CLASS_LINEPTR"},
        {DW_FORM_CLASS_LOCLIST, "CLASS_LOCLIST"},
        {DW_FORM_CLASS_LOCLISTSPTR, "CLASS_LOCLISTSPTR"},
        {DW_FORM_CLASS_MACPTR, "CLASS_MACPTR"},
        {DW_FORM_CLASS_RNGLIST, "CLASS_RNGLIST"},
        {DW_FORM_CLASS_RNGLISTSPTR, "CLASS_RNGLISTSPTR"},
        {DW_FORM_CLASS_REFERENCE, "CLASS_REFERENCE"},
        {DW_FORM_CLASS_STRING, "CLASS_STRING"},
        {DW_FORM_CLASS_STROFFSETSPTR, "CLASS_STROFFSETSPTR"},
};
...
{
        return get_mapping_string(ATTRIBUTE_FORM_CLASS, ARRAY_SIZE(ATTRIBUTE_FORM_CLASS), class);
}
